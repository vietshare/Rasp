...
def Categories():
	...
	addShowDir("Trấn Thành","http://hieuhien.vn/XBMC/LIVESHOW/TRANTHANH.xml",50,"http://i.imgur.com/b8lphNU.png")
	...
	AddDir("[COLOR white][B]{0}[/B][/COLOR]".format("Shutdown"), "Shutdown" ,99 ,os.path.join(addonDir, "resources", "images", "bright_yellow_star.png"), isFolder=False)
