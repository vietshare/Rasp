...
def m3u2list2323(url):
	...
	for params, display_name, url in matches:
		...
		item_data2 = {"display_name": display_name, "url": url}
		
		li.append(item_data)
		list.append(item_data2)
...
def m3u2list(url):
	...
	for params, display_name, url in matches:
		...
		if 'tvg-logo' in params:
			imgLoc = re.compile('tvg-logo=\"(.*)\"').findall(params)[0]

		item_data2 = {"display_name": display_name, "url": url, "logo": imgLoc}
		#li.append(item_data)
		list.append(item_data2)
